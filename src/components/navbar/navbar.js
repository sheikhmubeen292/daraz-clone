...
import { Grid, ListItemButton, Button, Box, TextField, useMediaQuery } from "@mui/material";
import "./navbar.css";
            ...
            <Grid alignItems="center" container spacing={3}>
              <Grid item md={2} >
                ...
                >
                  ...
                  <MenuItem aria-controls={open ? 'basic-menu' : undefined} aria-haspopup="true"
                    aria-expanded={open ? 'true' : undefined}
                    onMouseEnter={handleRightClick}>Health and beauty</MenuItem>
                ...
                <Menu
                  ...
                  onClose={() => { handleRightClick(); handleClose() }}
                  MenuListProps={{
                    'aria-labelledby': 'basic-button',
                  }}>
                  <MenuItem onClick={handleItemClick}>Categories and Pets</MenuItem>
                  <MenuItem onClick={handleItemClick}>Health and beauty</MenuItem>
                  <MenuItem aria-controls={open ? 'basic-menu' : undefined} aria-haspopup="true"
                    aria-expanded={open ? 'true' : undefined}
                    onMouseEnter={handleRightClick1}>Mens Fashion</MenuItem>
                </Menu>
                <Menu
                  id="basic-menu"
                  ...
                  onClose={() => { handleRightClick1(); handleClose(); handleRightClick(); }}
                  MenuListProps={{
                    'aria-labelledby': 'basic-button',
                  }}>
                  <MenuItem onMouseLeave={handleItemClick1}>Categories and Pets</MenuItem>
                  <MenuItem onMouseLeave={handleItemClick1}>Health and beauty</MenuItem>
              ...
              <Grid item xs={2}  >
                <ShoppingCartSharpIcon sx={{ color: "#000000", fontSize: "3rem", marginLeft:"1rem" }} />
              </Grid>
              <Grid item md={2} >
            ...
            <Grid alignItems="center">
              ...
              >
                <Box sx={{display: "flex", justifyContent:"space-between", flexDirection:"column", alignItems:"center"}}>
                  <TextField id="outlined-basic" variant="outlined" sx={{ width: 150, }} />
                  <SearchIcon sx={{ backgroundColor: "#F57208", width: "2rem", height: "3rem", borderRadius: "50%" }} />
                  <ShoppingCartSharpIcon sx={{ color: "#000000", fontSize:"2rem" }} />
