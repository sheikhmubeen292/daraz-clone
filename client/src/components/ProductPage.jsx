              ...
              <Box width={{ xs: "100%", md: "60%" }} p={1}>
                ...
                >
                  <Box>
                    ...
                    >
                      <span style={{ color: "grey" }}>Brand:</span> Aveesha
                      Textiles | More Bath from Aveesha Textiles
                    </Typography>
                  </Box>
                  <Box>
          ...
          <Grid item xs={12} md={4}>
            <Box bgcolor="#fff">
              <Box bgcolor="#fafafa" p={1.5}>
                ...
                <Divider color="#eff0f5" />
                <Typography color="grey !important" my={2} fontSize="13px">
                  Service
                </Typography>
                <Typography sx={{ fontSize: "14px", mt: 2 }}>
                  {" "}
                  <BookmarkBorderIcon sx={{ verticalAlign: "-10px" }} /> 7 Days
                  Returns
                </Typography>
                <Typography
                  color="grey !important"
                ...
                <Typography sx={{ fontSize: "14px", my: 2 }}>
                  {" "}
                  <LocalAtmIcon sx={{ verticalAlign: "-5px" }} /> 1 Year Brand
                  Warranty
                </Typography>
              </Box>
              ...
              <Box mt={2} bgcolor="#fafafa" p={1.5}>
                ...
                <Divider color="#eff0f5" />
                <Box sx={{ display: "flex" }}>
                  <Divider color="#eff0f5" orientation="vertical" flexItem />
                  <Box ml={1}>
                    <Typography
                      variant="subtitle1"
                      color="grey !important"
